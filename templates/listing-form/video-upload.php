    ...
    <div class="directorist-custom-field-file-upload__wrapper">
        <div class="" id="<?php echo esc_attr($id); ?>dropbox">
            ...
            <?php if (!empty($file_size)) { ?>
                <input type="hidden" name="<?php echo esc_attr($id); ?>_file_size" id="<?php echo esc_attr($id); ?>_file_size" value="<?php echo esc_attr($file_size); ?>" />
            <?php } ?>
			...
			" id="<?php echo esc_attr($id); ?>plupload-upload-ui">
                ...
                <input id="<?php echo esc_attr($id); ?>plupload-browse-button" type="button" value="<?php esc_attr_e('Select Files', 'directorist'); ?>" class="directorist-btn directorist-btn-primary" />
